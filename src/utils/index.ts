import { HinetContext, HinetContextTs } from "../interface/context";
...
export function format(s: string, c: HinetContext) {
...
export const template = '<html xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:x="urn:schemas-mic' +
